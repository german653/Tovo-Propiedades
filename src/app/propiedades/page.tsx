      ...
      <section className="bg-transparent pb-20 px-6">
         <div className="max-w-7xl mx-auto">
            ...
            <div className="mt-20 flex justify-center gap-4">
                ...
                <button className="w-12 h-12 border border-white/20 text-brand-cream flex items-center justify-center hover:border-white hover:text-white transition-colors">2</button>
                <button className="w-12 h-12 border border-white/20 text-brand-cream flex items-center justify-center hover:border-white hover:text-white transition-colors">3</button>
            </div>
         </div>
      </section>
    </motion.div>
