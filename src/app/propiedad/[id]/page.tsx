...
import { Bed, Bath, Move, MapPin, Share2, Heart, CheckCircle2, MessageCircle, ChevronLeft } from 'lucide-react';
...
export default function PropertyDetail() {
  ...
  if (!property) return <div className="h-screen flex items-center justify-center">Propiedad no encontrada</div>;
  ...
  return (
    ...
    >
      ...
      <div className="pt-32 pb-12 px-6 md:px-12 max-w-7xl mx-auto">
        <div className="mb-8">
            <Link href="/propiedades" className="text-[10px] uppercase tracking-widest font-bold text-white flex items-center gap-2 hover:translate-x-[-4px] transition-transform w-fit">
